...
function regexp(input) {
    if(!re_cache[input]) {
        re_cache[input] = new RegExp(input, "g");
    }
    return re_cache[input];
}
...
function _arabicChar(value) {
    ...
    for (var i = 0, charsLen = arabicChars.length; i < charsLen; i++) {
        value = value.replace(regexp(arabicChars[i]), persianChars[i]);
    }
    this._str = value;
    return this;
}
...
function _persianNumber(value) {
    ...
    for (var i = 0, numbersLen = englishNumbers.length; i < numbersLen; i++) {
        value = value.replace(regexp(persianNumbers[i]), englishNumbers[i]);
    }
...
function _arabicNumber(value) {
    ...
    for (var i = 0, numbersLen = arabicNumbers.length; i < numbersLen; i++) {
        value = value.replace(regexp(arabicNumbers[i]), persianNumbers[i]);
    }
    this._str = value;
    return this;
}
...
function _englishNumber(value) {
    ...
    for (var i = 0, numbersLen = englishNumbers.length; i < numbersLen; i++) {
        value = value.replace(regexp(englishNumbers[i]), persianNumbers[i]);
    }
    this._str = value;
    return this;
}
...
function _toEnglishNumber(value) {
    ...
    for (var i = 0, numbersLen = englishNumbers.length; i < numbersLen; i++) {
        value = value.replace(regexp(persianNumbers[i]), englishNumbers[i])
                        .replace(regexp(arabicNumbers[i]), englishNumbers[i]);
    }
    this._str = value;
    return this;
}
...
function _switchKey(value) {
    ...
    for (var i = 0, charsLen = persianChar.length; i < charsLen; i++) {
        value = value.replace(regexp(persianChar[i]), englishChar[i]);
    }
    this._str = value;
    return this;
}
