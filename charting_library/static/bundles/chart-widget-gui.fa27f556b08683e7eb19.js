    ...
    ["chart-widget-gui"], {
        ...
        "1ANp": function(t, e, i) {
            ...
            i.r(e), i.d(e, "VisibilityType", function() {
                    ...
                    return l
                }), i("YFKU"), a = i("bf9a"), r = i("m/cY"), d = i("Vdly"),
                function(t) {
        ...
        R5JZ: function(t, e, i) {
            ...
            function s(t, e, i, s, o) {
                ...
                return o.click && s.addEventListener("click", n, !1), o.mouseDown && s.addEventListener("mousedown", n, !1), o.touchEnd && s.addEventListener("touchend", n, !1), o.touchStart && s.addEventListener("touchstart", n, !1),
                    function() {
            ...
            i.r(e), i.d(e, "ControlBarNavigation", function() {
                ...
                M = '<div class="control-bar-wrapper">\n\t<div class="control-bar control-bar--hidden">\n\t\t<div class="control-bar__group js-btn-group js-btn-group-zoom">\n\t\t\t<div class="control-bar__btn control-bar__btn--zoom-out apply-common-tooltip" title="' + window.t("Zoom Out") + '">\n\t\t\t\t' + h + '\n\t\t\t</div>\n\t\t\t<div class="control-bar__btn control-bar__btn--zoom-in apply-common-tooltip" title="' + window.t("Zoom In") + '">\n\t\t\t\t' + p + '\n\t\t\t</div>\n\t\t</div>\n\t\t<div class="control-bar__group js-btn-group js-btn-group-maximize">\n\t\t\t<div class="control-bar__btn control-bar__btn--maximize apply-common-tooltip" title="' + window.t("Maximize chart") + '" data-tooltip-hotkey="' + C + '">\n\t\t\t\t' + v + '\n\t\t\t</div>\n\t\t\t<div class="control-bar__btn control-bar__btn--minimize js-hidden apply-common-tooltip" title="' + window.t("Restore chart") + '" data-tooltip-hotkey="' + C + '">\n\t\t\t\t' + w + '\n\t\t\t</div>\n\t\t</div>\n\t\t<div class="control-bar__group js-btn-group js-btn-group-scroll">\n\t\t\t<div class="control-bar__btn control-bar__btn--move-left apply-common-tooltip" title="' + window.t("Scroll to the Left") + '" data-tooltip-hotkey="' + E + '">\n\t\t\t\t' + u + '\n\t\t\t</div>\n\t\t\t<div class="control-bar__btn control-bar__btn--move-right apply-common-tooltip" title="' + window.t("Scroll to the Right") + '" data-tooltip-hotkey="' + V + '">\n\t\t\t\t' + _ + '\n\t\t\t</div>\n\t\t</div>\n\t\t<div class="control-bar__group js-btn-group js-btn-group-reset-scale">\n\t\t\t<div class="control-bar__btn control-bar__btn--turn-button control-bar__btn--btn-hidden apply-common-tooltip js-btn-reset" title="' + window.t("Reset Chart") + '" data-tooltip-hotkey="' + S + '">\n\t\t\t\t' + c + "\n\t\t\t</div>\n\t\t</div>\n\t</div>\n</div>", T = '<div class="control-bar control-bar__btn control-bar__btn--back-present control-bar__btn--btn-hidden apply-common-tooltip" title="' + window.t("Scroll to the Most Recent Bar") + '">\n\t' + b + "\n</div>", H = d.CheckMobile.any(), (f = {}).moving = "wait_finishing", f.wait_finishing = "stop", f.stop = "moving", x = f, A = "control-bar__btn--btn-hidden", L = {
                    ...
                    return t.prototype.destroy = function() {
                        ...
                        var t, e, i, s = this._leftPriceScaleWidth + this._paneWidth,
                            o = (s + this._rightPriceScaleWidth) / 2,
                            n = Math.min(s - o, o - this._leftPriceScaleWidth),
                            l = 2 * n - 50 - 50,
                            a = !1;
                        for (t = 0, e = this._visibilityPrioritizedGroups; t < e.length; t++)(i = e[t]).enoughSpaceForGroup = !1, i.available() && (!H || !i.shouldBeHiddenOnMobile) && (l -= i.totalWidth, i.enoughSpaceForGroup = l >= 0 && !a, a = a || !i.enoughSpaceForGroup), !i.enoughSpaceForGroup !== i.element.classList.contains("js-hidden") && i.element.classList.toggle("js-hidden", !i.enoughSpaceForGroup);
                        ...
                        var t = this._visibilityPrioritizedGroups.reduce(function(t, e) {
                            ...
                            e = this._paneWidth + this._leftPriceScaleWidth + this._rightPriceScaleWidth,
                            i = e / 2,
                            s = i - Math.ceil(t / 2);
        ...
        lvAK: function(t, e, i) {
            ...
            var o, n, l, a, r, d, u, h, c, p, _, b, g, m, v, w, y, f, S, C, E, V, M, T, H, x, A, L, P, B, k, O, D, z, j, W, N, R, I;
        ...
        sAH5: function(t, e, i) {
            ...
            var r, d, u, h, c, p, _, b, g, m, v, w, y, f, S, C, E, V, M, T, H, x, A, L, P, B, k, O, D, z, j, W, N, R, I, F, G, K, Z, q, Y, U, J, X, Q, $, tt, et, it, st, ot, nt, lt, at, rt, dt, ut, ht, ct, pt, _t, bt, gt, mt, vt, wt, yt, ft, St, Ct, Et, Vt, Mt, Tt, Ht, xt, At, Lt, Pt, Bt, kt, Ot, Dt, zt, jt, Wt, Nt, Rt, It, Ft;
            i.r(e), r = i("mrSG"), d = i("eJTA"), u = i("Eyy1"), i("H72D"), h = i("efOF"), c = i("EV8o"), p = i("S8xo"), _ = i("GUQs"), b = i("R5JZ"), g = i("5Alx"), m = i("0jws"), v = i("qFKp"), w = v.CheckMobile.any(), y = [g.title1st, g.title2nd, g.title3rd, g.title4th], f = 24, C = function(t) {
                ...
                return t.prototype.destroy = function() {
                    ...
                    if (this._withActions)
                        for (null === this._actionsParentEl && (this._actionsParentEl = document.createElement("div"), this._actionsParentEl.classList.add(g.buttonsWrapper), this._parentEl.append(this._actionsParentEl), this._actionAdditionalWrapperEl = document.createElement("div"), this._actionAdditionalWrapperEl.classList.add(g.buttons), this._actionsParentEl.appendChild(this._actionAdditionalWrapperEl)), t = Object(u.ensureNotNull)(this._actionAdditionalWrapperEl), e = 0, i = this._model.actions(); e < i.length; e++) s = i[e], o = Object(c.a)(s, g.button, g.buttonIcon, m.blockHidden), t.appendChild(o)
                    ...
                    null !== this._outsideEvent && this._outsideEvent(), this._outsideEvent = Object(b.a)(new h.CustomEvent("timestamp").timeStamp, this._el, this._cancelHoveredModeAndHide.bind(this), window.document, {
                        mouseDown: !0
                    })
                ...
                return t.prototype.destroy = function() {
                    ...
                    for (null === this._dataSourcesEl && (this._dataSourcesEl = document.createElement("div"), this._dataSourcesEl.classList.add(g.sourcesWrapper), this._renderToggle(this._dataSourcesEl), this._dataSourcesAdditionalWrapperEl = document.createElement("div"), this._dataSourcesAdditionalWrapperEl.classList.add(g.sources), this._dataSourcesEl.appendChild(this._dataSourcesAdditionalWrapperEl), this._renderCollapsedCounter(this._dataSourcesAdditionalWrapperEl), this._parentEl.appendChild(this._dataSourcesEl)), e = Object(u.ensureNotNull)(this._dataSourcesAdditionalWrapperEl), i = function(t) {
                            ...
                            s._dataSourceRenderers.push(i), s._updateLegendVisibility(), t.onDestroy().subscribe(s, function() {
                                var t = l._dataSourceRenderers.indexOf(i); - 1 !== t && (l._dataSourceRenderers[t].destroy(), l._dataSourceRenderers.splice(t, 1))
                            }, !0)
                    ...
                    var t, e, i, s, o = this._showBackground.value(),
                ...
                return t.prototype.destroy = function() {}, t.prototype.onDestroy = function() {
                    ...
                    if (null !== o)
                        for (t = o.getSplitTitle(), e = 0; e < this._titles.length; e++) i = t[e], s = Object(Y.clean)(Array.isArray(i) ? i.join(" ") : i || "", !0), this._titles[e].setValue(s)
                }, t.prototype._updateStates = function() {
                ...
                return Object(r.__extends)(e, t), e.prototype.destroy = function() {
                    ...
                    var t, e, i, s, n = this._source.legendView(),
                    ...
                    if (0 === l.length) t = n.items().map(function(t) {
                        ...
                        for (e = n.items(), i = 0; i < e.length; i++) s = e[i], l[i].value.setValue(s.value()), l[i].color.setValue(o(s.color())), l[i].visible.setValue(s.visible()), l[i].title.setValue(s.title())
                }, e.prototype._updateStates = function() {
                ...
                }, e.prototype._updateSymbolMarker = function() {}, e
                ...
                return Object(r.__extends)(e, t), e.prototype.destroy = function() {
                    ...
                    }, e.prototype.onShowSourceCode = function() {}, e.prototype.setGlobalVisibility = function(t) {
                        ...
                        if (null !== a && 0 !== a.items().length)
                            if (0 === (t = this._values.value()).length) e = a.items().map(function(t) {
                                return {
                                    value: new R.a(t.value()),
                                    color: new R.a(o(t.color())),
                                    visible: new R.a(t.visible())
                                ...
                                for (i = a.items(), s = 0; s < i.length; s++) n = t[s], l = i[s], n.value.setValue(l.value()), n.color.setValue(o(l.color())), n.visible.setValue(l.visible())
                    }, e.prototype._updateStates = function() {
                ...
                function t(t, e, i, s, o, n) {
                    ...
                    this._mainSeriesViewModel = null, this._dataSourceViewModels = [], this._visibleDataSourceCount = new R.a(0), this._themedColor = new R.a(""), this._mainSeriesRowHidden = null, this._dataSourceRowsHidden = [], this._allLegendHidden = new R.a(!1), this._studiesLegendHidden = new R.a(!1), this._onLegendVisibilityToggled = null, this._availableHeight = 0, this._collapsedDataSourcesCount = new R.a(0), this._collapsedDataSourcesTitle = new R.a(""), this._model = t, this._paneWidget = e, this._options = Object(Et.merge)(Object(Et.clone)(Wt), o), this._callbacks = Object(r.__assign)(Object(r.__assign)({}, n), {
                        ...
                        }, this._dataSourceViewModelsOptions = Object(r.__assign)(Object(r.__assign)({}, this._mainSeriesViewModelsOptions), {
                            canShowSourceCode: this._options.canShowSourceCode
                        }), this._backgroundThemeName = i, l = this._model.model().properties().paneProperties.legendProperties.showLegend, this._isDataSourcesCollapsed = new R.a(l.value()),
                ...
                return t.prototype.destroy = function() {
                    ...
                    return l(this._model, this._options.contextMenu, this._callbacks.showGeneralChartProperties, t, e)
                    ...
                    if (l > -1 ? (o.splice(l, 1), Nt || null !== this._mainSeriesViewModel || (this._mainSeriesViewModel = new lt(this._model, n, this._mainSeriesViewModelsOptions, this._callbacks), this._renderer.addMainDataSource(this._mainSeriesViewModel))) : null !== this._mainSeriesViewModel && (this._mainSeriesViewModel.destroy(), this._mainSeriesViewModel = null), t = [], 0 === (e = this._dataSourceViewModels.length))
                        for (i = o.length - 1; i >= 0; i--) t.push(new St(this._model, o[i], this._dataSourceViewModelsOptions, this._callbacks));
                    else {
                    ...
                    this._availableHeight = Rt * t, this._updateCollapsedSourcesModeThrottle()
                }, t.prototype._updateCollapsedSourcesMode = function() {
                    var t, e, i, s, o, n, l, a, r, d = this._dataSourceViewModels.length;
                    if (!this._wrapText.value() && this._availableHeight > 0 && d > It && (t = this._renderer.getMainSourceHeight(), e = this._renderer.getDataSourceHeight(), null !== t && null !== e && (i = Math.floor((this._availableHeight - t) / e), d > (s = Math.max(i, It) - 1) + 1))) {
