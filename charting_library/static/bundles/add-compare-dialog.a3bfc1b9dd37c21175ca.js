    ...
    ["add-compare-dialog"], {
        UnpO: function(t, e, o) {
            ...
            Object.defineProperty(e, "__esModule", {
                value: !0
            }), e.AddSymbolTab = void 0, a = function() {
                function t(t, e) {
                    var o, a;
                    for (o = 0; o < e.length; o++)(a = e[o]).enumerable = a.enumerable || !1, a.configurable = !0, "value" in a && (a.writable = !0), Object.defineProperty(t, a.key, a)
                }
                return function(e, o, a) {
                    return o && t(e.prototype, o), a && t(e, a), e
                }
            }(), n = o("dKfe"), i = o("pZll"), o("UxRG"), o("k47Q"), c = '\n\t<div class="tv-add-symbol-tab">\n\t\t<input type="text" class="tv-control-input js-add-symbol-tab-input" placeholder="' + $.t("Symbol") + '" autocomplete="off">\n\t\t<div class="tv-add-symbol-tab__add-symbol-overlay js-add-symbol-tab-checkbox"></div>\n\t</div>', e.AddSymbolTab = function() {
                function t(e, o) {
                    ! function(t, e) {
                        if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                    }(this, t), this._chartWidgetCollection = e, this._dialog = o, this._$popup = null, this.init()
                }
                return a(t, [{
                    key: "init",
                    value: function() {
                        var t = this;
                        this.$tab = $(c), this._$input = this.$tab.find(".js-add-symbol-tab-input"), this._checkbox = new n.AddSymbolCheckbox({
                        ...
                        }), this.$tab.find(".js-add-symbol-tab-checkbox").append(this._checkbox.$el), (0, i.symbolSearchUIService)().bindToInput(this._$input, {
                            callback: function(e) {
        ...
        dKfe: function(t, e, o) {
            ...
            Object.defineProperty(e, "__esModule", {
                value: !0
            }), e.AddSymbolCheckbox = void 0, a = o("QwKQ"), n = (i = a) && i.__esModule ? i : {
                default: i
                ...
                function e(t) {
                    ...
                    return o.$checkbox.change(function() {
                        setTimeout(function() {
        ...
        ocUP: function(t, e, o) {
            ...
            (function(t, a) {
                ...
                Object.defineProperty(e, "__esModule", {
                    value: !0
                }), e.CompareTab = void 0, n = function() {
                    function t(t, e) {
                        var o, a;
                        for (o = 0; o < e.length; o++)(a = e[o]).enumerable = a.enumerable || !1, a.configurable = !0, "value" in a && (a.writable = !0), Object.defineProperty(t, a.key, a)
                    }
                    ...
                    return n(e, [{
                        ...
                        value: function(t) {
                            ...
                            a && (e = a.model()) && e.dataSources().forEach(function(a) {
                                if (a._metaInfo && "Compare@tv-basicstudies" === a._metaInfo.id) {
                                    var n = a.properties().inputs.symbol.value();
                                    (n === t || o._symbolAlias[n] && o._symbolAlias[n] === t) && e.removeSource(a)
                                }
                            })
                        }
                    }, {
                        ...
                        value: function() {
                            ...
                            i && (e = i.model()) && (o = e.dataSources(), this.$tab = $(l), this._initSymbolSearch(), t.enabled("charting_library_base") || (this._createPredefinesList(), (a = this.$tab.find(".js-compare-tab-predefines")).find(".js-predefine-checkbox").attr("checked", !1), Object.keys(this._predefines).forEach(function(t) {
                                var e = n._symbolToId(t),
                                    i = a.find("#" + e);
                                o.forEach(function(e) {
                                    if (e._metaInfo && "Compare@tv-basicstudies" === e._metaInfo.id) {
                                        var o = e.properties().inputs.symbol.value();
                                        (o === t || n._symbolAlias[o] && n._symbolAlias[o] === t) && i.attr("checked", !0)
                                    }
                                })
                            })))
                        }
                        ...
                        value: function() {
                            var t = this;
                            this._$input = this.$tab.find(".js-compare-tab-input"), (0, i.symbolSearchUIService)().bindToInput(this._$input, {
                                callback: function(e) {
                        ...
                        value: function() {
                            function t(t) {
                                var e = this;
                                setTimeout(function() {
                                    $(e).is(":checked") ? o._addCompareSymbol(t.data.symbol).then(function(t) {
                                        t || $(e).attr("checked", !1)
                            ...
                            Object.keys(this._predefines).forEach(function(o) {
                                var i = $(a.render(s, {
                                        ...
                                        additionalClass: e._isBovespa ? "tv-compare-tab__predefine-cell--wide" : ""
                                    })),
        ...
        tkV1: function(t, e, o) {
            ...
            Object.defineProperty(e, "__esModule", {
                value: !0
            }), e.AddCompareDialog = void 0, a = function() {
                function t(t, e) {
                    var o, a;
                    for (o = 0; o < e.length; o++)(a = e[o]).enumerable = a.enumerable || !1, a.configurable = !0, "value" in a && (a.writable = !0), Object.defineProperty(t, a.key, a)
                }
            ...
            }(), n = o("ocUP"), i = o("UnpO"), c = o("NhD9"), o("jPTo"), l = null, e.AddCompareDialog = function() {
                function t(e) {
                    ! function(t, e) {
                        if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                    }(this, t), this._chartWidgetCollection = e, this._$symbolSearchPopup = null, this._dialog = null, this._compareTab = new n.CompareTab(this._chartWidgetCollection, this), this._addSymbolTab = new i.AddSymbolTab(this._chartWidgetCollection, this)
                }
                return a(t, [{
                    key: "show",
                    value: function() {
                        ...
                        return o.push({
                            ...
                            isClickOutFn: function(t) {
                                if (e._compareTab.isClickOnTab(t) || e._addSymbolTab.isClickOnTab(t)) return !1
                            }
                        }), l && l.close(), this._dialog = t.dialog, this._dialog.open(), l = this._dialog, this._dialog
                    }
                }, {
                    key: "getZIndex",
                    value: function() {
