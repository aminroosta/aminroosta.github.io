        ...
        PI1I: function(e, t, n) {
            ...
            function o(e) {
                var t = e.themeName,
                    ...
                    s = r[0],
                    c = r[1];
                return i.createElement("div", Object(l.__assign)({}, c), i.createElement(g.b, {
                    className: B.defaultsButtonItem,
                    isActive: !1,
                    label: t,
                    onClick: function() {
                        Object(C.loadTheme)(t, !1, !1, n).then(function() {
                            window.saver.saveChartSilently(), Object(P.trackEvent)("GUI", "Switch to custom theme")
                        })
                    },
            ...
            var i, a, l, r, s, c, m, u, d, p, h, b, f, y, _, g, v, C, T, S, A, k, w, P, E, B, x, I, N, D, z, O, V, M, j, W, L, R, K, q, H, Q, U, F;
            n.r(t), n("YFKU"), i = n("q1tI"), a = n("i8i4"), l = n("mrSG"), r = n("TSYQ"), s = n("vWed"), c = n("jjrI"), m = n("bvfV"), u = n("ycFu"), d = n("ybVX"), p = n("Q+1u"), h = n("Vdly"), b = n.n(h), f = n("VNzU"), y = n("/KDZ"), n("bSeV"), _ = n("H172"), g = n("N5tr"), v = n("KKsp"), C = n("EsvI"), n("HbRj"), T = n("CLNU"), S = n("oNDq"), A = window.t("Do you really want to delete Color Theme '{0}' ?"), k = n("+EG+"), n("bf9a"), w = n("i/MG"), P = n("PC8g"), E = n("8d0Q"), B = n("utEQ"), x = n("HWhk"), I = window.t("Template"), N = window.t("Apply Defaults"), window.t("Save As..."), D = window.t("Apply to all"), z = function(e) {
                function t(t) {
                    ...
                    return n._manager = null, n._handleApplyDefaults = function() {
                        ...
                        o.restorePreferences(), e = Object(C.getCurrentTheme)().name, Object(C.loadTheme)(e, !0, !0, i)
                ...
                return Object(l.__extends)(t, e), t.prototype.render = function() {
                    var e = this;
                    return i.createElement(k.b.Consumer, null, function(t) {
                        return e._manager = t, i.createElement(y.a, {
                    ...
                    var t, n = this,
                        ...
                        c = e && r ? Object(l.__spreadArrays)([this._applyToAllDropdownItem, this._getPlaceHolderItem(e)], this._defaultDropdownItems) : Object(l.__spreadArrays)([this._getPlaceHolderItem(e)], this._defaultDropdownItems),
                        m = this.state.themes;
                    return m.length ? ((t = m.map(function(e) {
                        return {
                            value: e,
                            readonly: !0,
                    ...
                    return {
                        ...
                        readonly: !0,
                        content: "",
                        selectedContent: e ? i.createElement(c.a, {
                            className: B.themesButtonIcon,
                            icon: x
                        }) : I
                    }
                }, t
            }(i.PureComponent), O = n("tWVy"), V = n("yqnI"), M = n("uhCe"), j = n("tmL0"), W = {
            ...
            }, L = n("++0f"), R = n("U0JK"), K = n("sXZi"), q = "properties_dialog.last_page_id", H = function(e) {
                function t(t) {
                    var n, o, a, l, r = e.call(this, t) || this;
                    return r._renderChildren = function(e) {
                        var t = e.requestResize,
                            n = e.isSmallWidth;
                        return r._requestResize = t, i.createElement("div", {
                            className: K.content
                        }, r._renderTabs(n), r._renderTabContent(n))
                        ...
                        e !== t && (t && t.definitions.unsubscribe(r._onChangeActivePageDefinitions), b.a.setValue(q, e.id), e.definitions.subscribe(r._onChangeActivePageDefinitions), r.setState({
                            activePage: e,
                            tableKey: Date.now()
                        }, function() {
                        ...
                        V.a.logNormal("Definition collection was updated"), r.setState({
                            tableKey: Date.now()
                        }, function() {
                            r._requestResize && r._requestResize()
                        })
                        ...
                        r.setState({
                            isApplyToAllVisible: Object(f.isMultipleLayout)(e.layout.value())
                        })
                    }, r._handleBackClick = function() {
                        var e = r.state.activePage;
                        e && e.definitions.unsubscribe(r._onChangeActivePageDefinitions), r.setState({
                            activePage: null
                        })
                    }, n = t.pages, o = t.activePageId, (a = n.find(function(e) {
                        return e.id === o
                    })) || (l = b.a.getValue(q), a = n.find(function(e) {
                        return e.id === l
                    }) || n[0]), r.state = {
                        activePage: a,
                        isApplyToAllVisible: Object(f.isMultipleLayout)(t.chartWidgetCollection.layout.value()),
                        tableKey: Date.now()
                    }, r
                }
                return Object(l.__extends)(t, e), t.prototype.componentDidMount = function() {
                    ...
                    return i.createElement(y.a, {
                        ...
                        return i.createElement(u.a, {
                            ...
                            additionalHeaderElement: null !== a && t ? i.createElement(c.a, {
                    ...
                    var t, n, o = this.props.pages,
                        a = this._getCurrentPage(e);
                    return a ? (n = (t = o.find(function(e) {
                        return e.id === a.id
                    })) ? t.definitions.value() : [], i.createElement(j.a, {
                    ...
                    var t, n = this,
                        o = this.props.pages,
                        a = this.state.activePage;
                    return a && e ? null : (t = this._getCurrentPage(e), i.createElement("div", {
                        className: K.sidebar,
                        onScroll: this._handleScroll
                    }, o.map(function(o) {
                        return i.createElement("div", {
                    ...
                    return !e && t && i.createElement("span", {
            ...
            }(i.PureComponent), Q = n("FQhm"), n.d(t, "GeneralChartPropertiesDialogRenderer", function() {
                return F
            }), U = window.t("Chart settings"), F = function() {
                function e(e) {
                    var t = this;
                    this._container = document.createElement("div"), this._isVisible = !1, this._handleClose = function() {
                        a.unmountComponentAtNode(t._container), t._isVisible = !1, t._onClose && t._onClose()
                    }, this._handleSubmit = function() {}, this._handleCancel = function() {
                        t._model.undoToCheckpoint(t._checkpoint)
                    }, this._propertyPages = e.propertyPages, this._model = e.model, this._activePageId = e.activePageId, this._onClose = e.onClose, this._chartWidgetCollection = e.chartWidgetCollection, this._checkpoint = this._ensureCheckpoint(e.undoCheckPoint)
                }
                return e.prototype.hide = function(e) {
                    e ? this._handleCancel() : this._handleSubmit(), this._handleClose()
                }, e.prototype.isVisible = function() {
                    return this._isVisible
                }, e.prototype.focusOnText = function() {}, e.prototype.show = function() {
                    a.render(i.createElement(H, {
                        title: U,
                        isOpened: !0,
                    ...
                    }), this._container), this._isVisible = !0, Q.emit("edit_object_dialog", {
