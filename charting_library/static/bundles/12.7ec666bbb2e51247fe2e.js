    ...
    [12], {
        ...
        kSQs: function(t, e, o) {
            ...
            o.d(e, "a", function() {
                ...
                return Object(h.__extends)(e, t), e.prototype.render = function() {
                    var t, e, o, i = this.props,
                        r = i.children,
                        s = void 0 === r ? [] : r,
                        n = i.show,
                        c = void 0 !== n && n,
                    ...
                    return Object(u.isRtl)() && (e = g.left, o = g.right, g = Object(h.__assign)(Object(h.__assign)({}, g), {
                        left: o,
                        right: e
                    })), p.createElement("div", {
                        style: g,
            ...
            }(p.PureComponent), r = Object(c.a)((s = i, (n = function(t) {
                function e(e) {
                    ...
                    }, o.state = o._getStateFromProps(), o
                }
                return Object(h.__extends)(e, t), e.prototype.componentDidMount = function() {
                    this._instanceElem = l.findDOMNode(this._instance), this.props.attachOnce || this._subscribe(), this.setState(this._calcProps(this.props))
                }, e.prototype.componentDidUpdate = function(t) {
                    var e = this;
                    t.children === this.props.children && t.top === this.props.top && t.left === this.props.left && t.width === this.props.width || this.setState(this._getStateFromProps(), function() {
                    ...
                    }, p.createElement(s, Object(h.__assign)({}, this.props, {
                    ...
                    if (t.target && t.attachment && t.targetAttachment) {
                        if (null === (e = this._calcTargetProps(t.target, t.attachment, t.targetAttachment))) return {};
                        switch (i = (o = this.props).width, s = void 0 === (r = o.inheritWidthFromTarget) || r,
                            h = void 0 !== (n = o.inheritMaxWidthFromTarget) && n, p = {
                                width: s ? e.width : i,
                    ...
                    var i, r, s, n, h = t.getBoundingClientRect(),
                        p = this._instanceElem.getBoundingClientRect(),
                        a = "parent" === this.props.root ? this._getCoordsRelToParentEl(t, h) : this._getCoordsRelToDocument(h);
                    if (null === a) return null;
                    switch (i = this._getDimensions(p), r = this._getDimensions(h).width, s = 0, n = 0, e.vertical) {
                        case "top":
                            n = a[o.vertical];
                            break;
                        case "bottom":
                    ...
                    return "number" == typeof this.props.attachmentOffsetY && (n += this.props.attachmentOffsetY), "number" == typeof this.props.attachmentOffsetX && (s += this.props.attachmentOffsetX), {
                        x: s,
                        y: n,
                        width: r
                    }
                    ...
                    var o, i, r, s, n, h = t.offsetParent;
                    return null === h ? null : (o = h.scrollTop, i = h.scrollLeft, r = t.offsetTop + o, s = t.offsetLeft + i, n = e.width + s, {
                        top: r,
                        bottom: e.height + r,
                        left: s,
                        right: n,
            ...
            }(p.PureComponent)).displayName = "Attachable Component", n))
        }
    }
]);