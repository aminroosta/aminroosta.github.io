! function(t, e) {
    ...
    function o(t, n) {
        var i = e({}, t);
        for (var s in n) "object" != typeof t[s] || null === t[s] || Array.isArray(t[s]) ? void 0 !== n[s] && (i[s] = n[s]) : i[s] = o(t[s], n[s]);
        return i
    }
    var n = {
            mobile: {
    ...
    function s() {
        return "1.16 dev (internal id e38edb10 @ 2020-04-21 04:34:57.458348)"
    }
    var r = function() {
        function t(t) {
